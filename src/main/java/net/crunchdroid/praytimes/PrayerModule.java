...
import net.crunchdroid.praytimes.AstroModule.*;

import static java.lang.Math.*;
import static net.crunchdroid.praytimes.AstroModule.*;
import static net.crunchdroid.praytimes.ExtremeMethod.ANGLE_BASED;
